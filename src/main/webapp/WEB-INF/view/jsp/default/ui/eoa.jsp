...
<div class="loginArea02">
    ...
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        <div class="loginBor01">
            ...
            <div class="forms">
                ...
                <div class="lineDi selecTex" style="display: inline"><input type="checkbox" tabindex="5" id="rememberMe" name="rememberMe"
                                                                            value="true"/><spring:message
                        code="screen.rememberme.checkbox.title"/>
                </div>
    ...
    <div style="position:absolute;right:0;bottom:-130px;"><span style="font-size:14px;color:#333;margin-right:20px;">扫一扫下载手机客户端 &gt;&gt;</span><img
            src="/eoa/eoa_apk.png" style="width:130px;height:130px;float:right;"/></div>
</div>
