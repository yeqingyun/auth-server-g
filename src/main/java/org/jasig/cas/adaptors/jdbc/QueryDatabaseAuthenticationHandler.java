...
public class QueryDatabaseAuthenticationHandler extends AbstractJdbcUsernamePasswordAuthenticationHandler {
    ...
    protected void validateUsernameAndPassword(String username, String encryptedPassword) throws FailedLoginException, AccountNotFoundException, PreventedException {
        try {
            final String dbPassword = getJdbcTemplate().queryForObject(this.sql, String.class, username);
            if (!dbPassword.equalsIgnoreCase(encryptedPassword)) {
